...
const Form = () => {
  ...
  return (
    <form className="p-5 flex gap-10 justify-center items-center w-5/6 mx-auto" onSubmit={handleSubmit}>
      <p>What do you need for your trip?</p>

      <select name="" className="p-2 rounded-md" id="" value={quantity} onChange={(e) => setQuantity(Number(e.target.value))}> 
